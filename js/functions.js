...
function switch_side_to(show_side){
	...
	side = show_side;
	var side_names = [lang("login"),lang("book_return_and_lend_side_title"),lang("catalog_side_title"),lang("customers_side_title"),lang("lists_side_title"),lang("admin_side_title")];
